...
type NodeRegistrationClient interface {
	...
	SendHeartBeat(ctx context.Context, in *Signal, opts ...grpc.CallOption) (*Signal, error)
...
func (c *nodeRegistrationClient) SendHeartBeat(ctx context.Context, in *Signal, opts ...grpc.CallOption) (*Signal, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Signal)
...
type NodeRegistrationServer interface {
	...
	SendHeartBeat(context.Context, *Signal) (*Signal, error)
...
func (UnimplementedNodeRegistrationServer) SendHeartBeat(context.Context, *Signal) (*Signal, error) {
...
func _NodeRegistration_SendHeartBeat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NodeRegistrationServer).SendHeartBeat(ctx, req.(*Signal))
	}
	return interceptor(ctx, in, info, handler)
}
